...
const beforeAfter = [
    ...
    },
    {
        ...
        afterDesc: 'So we cut out the damaged area and patched in a new piece.',
    },
    {
        name: 'Fraying at the patio door',
        desc: 'This type of damage is almost always due to a pet. In this case it has already been patched once.',
    ...
    },
    {
        ...
        desc: "We don't always know how it happens.",
    ...
    {
        name: 'Snag on a stair lip in a common hallway',
        desc: 'Woven carpet like this can snag and over time will look like this. This type of patch is really hard to correct.',
        before: 'stairlip_0-1.jpg',
        after: ['stairlip_1-1.jpg'],
        afterDesc: 'But no patch is impossible with a little time and effort.',
    },
    {
        name: 'Pet damage on the stairs',
        desc: "Cats will scratch and sometimes it's on the stairs.",
        before: 'stairs_0-1.jpg',
        after: ['stairs_1-1.jpg'],
        afterDesc: 'We can fix that no problem!',
    },
    {
        name: 'Very wrinkled carpet',
